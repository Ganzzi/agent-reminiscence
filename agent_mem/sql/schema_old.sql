...
-- Function to increment update_count on active_memory updates
...
-- Trigger to track updates for consolidation threshold
DROP TRIGGER IF EXISTS trigger_increment_active_memory_count ON active_memory;
...
--
-- 4. Consolidation threshold (update_count >= 5) is configurable in code
